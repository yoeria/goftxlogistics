...
type ChartDataExchangeClient interface {
	GetOHLC(ctx context.Context, in *WindowSize, opts ...grpc.CallOption) (*WindowDataArray, error)
}
...
func (c *chartDataExchangeClient) GetOHLC(ctx context.Context, in *WindowSize, opts ...grpc.CallOption) (*WindowDataArray, error) {
	out := new(WindowDataArray)
	err := c.cc.Invoke(ctx, "/protos.chartDataExchange/getOHLC", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ChartDataExchangeServer interface {
	GetOHLC(context.Context, *WindowSize) (*WindowDataArray, error)
...
func (UnimplementedChartDataExchangeServer) GetOHLC(context.Context, *WindowSize) (*WindowDataArray, error) {
...
func _ChartDataExchange_GetOHLC_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(WindowSize)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ChartDataExchangeServer).GetOHLC(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protos.chartDataExchange/getOHLC",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChartDataExchangeServer).GetOHLC(ctx, req.(*WindowSize))
	}
...
var ChartDataExchange_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "getOHLC",
			Handler:    _ChartDataExchange_GetOHLC_Handler,
		},
	},
